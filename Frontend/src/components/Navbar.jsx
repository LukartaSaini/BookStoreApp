...
function Navbar() {
  ...
  const navItems = (
    <>
      <li><a href='/' className='dark:text-white dark:bg-slate-700'>Home</a></li>
      <li><a href='/course' className='dark:text-white dark:bg-slate-700'>Course</a></li>
      <li><a href ="/contact" className='dark:text-white dark:bg-slate-700'>Contact</a></li>
      <li><a className='dark:text-white dark:bg-slate-700'>About </a></li>
    </>
  )


  return (
    <div className={`max-w-screen-2xl dark:bg-slate-900 dark:text-white container mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 z-50 ${sticky ? "sticky-navbar shadow-md bg-base-200 dark:bg-slate-600 dark:text-white duration-300 transition-all ease-in-out" : ""}`}>
